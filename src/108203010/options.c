...
void options_show_usage (void) {
    fprintf(stdout, "usage: 108203010 -h\n"
                    "       108203010 --help\n"
                    "       108203010 [OPTIONS]...\n"
                    "\n"
                    "    Generate random triangles whose vertices are from the interval [0, 1)\n"
                    "    and report on selected statistics of the set of drawn triangles.\n"
                    "\n"
                    "    Options\n"
                    "        -a, --report_avg\n"
